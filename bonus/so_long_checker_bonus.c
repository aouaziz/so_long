...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   so_long_checker_bonus.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: aouaziz <aouaziz@student.42.fr>            +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/17 11:10:37 by aouaziz           #+#    #+#             */
/*   Updated: 2023/02/28 15:25:13 by aouaziz          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/so_long_bonus.h"

void	ft_check_pecm10(char *map)
{
	t_so_long	s;
...
void	ft_check_pce(t_so_long *s)
{
	...
	ft_flood_fill_cpm(s->map_cp, s->px, s->py);
	ft_flood_fill_e(s->map_e, s->px, s->py);
	ft_check_flood_cpm(s->map_cp);
